    ...
    <main className="w-full flex flex-col gap-4 items-center bg-black">
      <section className="container flex flex-col gap-12 md:gap-24 lg:gap-[114px] px-4 sm:px-6 py-10 md:py-10 lg:py-32">
        <div className="relative w-full">
          <Image src={experienceType} alt="User Experience" className="absolute w-[140px] top-0 mt-6 md:w-56 lg:w-auto lg:mt-6" />

          <h1 className="text-[#F4F6FA] text-[36px] leading-normal sm:text-[48xp] sm:leading-[48px] md:text-[54px] md:leading-[54px] lg:text-[71px] font-bold lg:leading-[71px]">
            <span className="text-[#F4F6FA] text-[36px] leading-normal sm:text-[48px] sm:leading-[48px] md:text-[54px] md:leading-[54px] lg:text-[71px] lg:leading-[71px] font-bold ml-2 md:ml-5 lg:ml-[50px]">DESIGN</span>
             - Projeto experiências digitais que conectam as pessoas</h1>
        </div>

        <div className="w-full flex flex-col md:flex-row gap-12 lg:gap-[136px]">
          <div className="relative">
            <Image src={smileImage} width={48} alt="smile icon" className="absolute -bottom-5 -right-2 sm:right-48 md:right-0 md:bottom-2 md:w-[40px] lg:-right-5 lg:-bottom-5 z-20" />
            <Image 
              src={experienceMark} 
              width={1200} 
              alt="Experience" 
            ...
            <div className="relative z-10">
              <Image 
                src={bannerHero} 
                alt="Banner Hero" 
                className="w-auto px-4 sm:w-[388px] lg:w-[488px] lg:px-0 rounded-xl" 
              />
            </div>
          </div>

          <div className="flex flex-col gap-4 md:max-w-[388px] lg:max-w-[488px]">
            <h2 className="text-[#F4F6FA] text-xl lg:text-[28px] font-bold">Sou apaixonado por criar soluções que simplificam a vida das pessoas</h2>
